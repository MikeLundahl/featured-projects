...
var CardsContainer = /*#__PURE__*/function (_Component) {
  ...
  _proto.oninit = function oninit(vnode) {
    _Component.prototype.oninit.call(this, vnode);
    this.defaultImage = flarum_forum_app__WEBPACK_IMPORTED_MODULE_3___default().forum.attribute('mbl-featured-projects.default_image');
    this.cardPrevLoading = [];
    this.cardPrev = [];
    this.loading = true;
    this.clickTag = flarum_forum_app__WEBPACK_IMPORTED_MODULE_3___default().forum.attribute('mbl-featured-projects.plausibleTag');
    this.clickTagSponsor = flarum_forum_app__WEBPACK_IMPORTED_MODULE_3___default().forum.attribute('mbl-featured-projects.sponsor_tracking_tag');
    this.sponsorImg = flarum_forum_app__WEBPACK_IMPORTED_MODULE_3___default().forum.attribute('mbl-featured-projects.sponsor_image_url');
    this.sponsorUrl = flarum_forum_app__WEBPACK_IMPORTED_MODULE_3___default().forum.attribute('mbl-featured-projects.sponsor_url');
    this.sponsorTitle = flarum_forum_app__WEBPACK_IMPORTED_MODULE_3___default().forum.attribute('mbl-featured-projects.sponsor_title');
    this.sponsorIsActive = flarum_forum_app__WEBPACK_IMPORTED_MODULE_3___default().forum.attribute('mbl-featured-projects.sponsor_is_active');
    this.sponsorNewTab = flarum_forum_app__WEBPACK_IMPORTED_MODULE_3___default().forum.attribute('mbl-featured-projects.sponsor_new_tab');
    this.sponsorTarget = '_self';
    this.classesSponsor = "FeaturedCardLink " + this.clickTagSponsor;
    for (var i = 0; i < 3; i++) {
      this.cardPrevLoading.push(m(_featured_card_FeaturedCard__WEBPACK_IMPORTED_MODULE_6__["default"], {
        title: "Loading...",
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 10:
            ...
            _context.next = 14;
            return flarum_forum_app__WEBPACK_IMPORTED_MODULE_3___default().store.find('discussions', {
              filter: {
  ...
  _proto.view = function view() {
    ...
    }, this.sponsorIsActive > 0 && m("a", {
      className: this.classesSponsor,
      href: this.sponsorUrl,
      target: this.sponsorTarget
    }, m(_featured_card_FeaturedCard__WEBPACK_IMPORTED_MODULE_6__["default"], {
      title: this.sponsorTitle,
      image: this.sponsorImg
    })), this.cardPrev.length > 0 ? this.cardPrev.map(function (card) {
      return card;
    }) : this.cardPrevLoading.map(function (card) {
      return card;
