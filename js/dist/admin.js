...
flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('mbl/featured-projects', function () {
  console.log('[mbl/featured-projects] Hello, admin!');
  flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().extensionData["for"]('mbl-featured-projects').registerPermission({
    icon: 'fas fa-rocket',
    // Font-Awesome Icon
